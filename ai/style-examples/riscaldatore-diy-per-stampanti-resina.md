...
A causa dell'odore della resina, ho preferito mettere la stampante in un garage, dove però in questo periodo (novembre) ci sono circa 10° mentre la resina necessita di una temperatura di 25-30° per essere stampata.
...
![Temperatura garage vs stampante](/images/PXL_20211128_231435379.jpg)
...
![Riscaldatore PTC 12V 100W](/images/61WCcFX8LsL._AC_SL1001_.jpg)
...
![Termostato W1209WK](/images/71iu6hZFR-S._AC_SL1500_-1024x1024.jpg)
...
![Alimentatore 12V 10A](/images/71FRWXcGyFL._AC_SL1200_.jpg)
...
![Connettori DC](/images/61-9PT-wCRL._AC_SL1500_-1024x810.jpg)
...
2. Nel secondo e terzo connettore del termostato va il negativo dell'alimentatore, io ho ponticellato con un cavo, non fate l'errore di usare un puntalino a U perché sfregando sul connettore alla lunga lo scioglie
3. Nel quarto connettore va uno dei due cavi del riscaldatore (è una resistenza quindi non ha positivo e negativo), l'altro cavo del riscaldatore va insieme al positivo dell'alimentatore
4. I due cavi della ventola vanno collegati all'alimentatore in modo che la ventola sia sempre accesa
5. Quando montate la ventola sul box, ricordatevi che il lato con l'adesivo va verso il riscaldatore, in pratica una volta montato voi vedete il lato senza adesivo della ventola

Mi raccomando, fate attenzione ai collegamenti: devono essere ben serrati e non "ballare".

![Schema collegamenti](/images/image-1024x481-1.png)
...
1. Leggete la temperatura sul normale termometro, la chiameremo T1. Leggete la temperatura sul termostato (il valore più alto), la chiameremo T2. Ora fate T2 - T1 e otteniamo T3, memorizzatevi questo valore
2. Tenete premuto il pulsante SET del termostato per entrare in modalità programmazione fino a quando sentite un BEEP e vedete comparire P0 sul display (tenete a mente questa procedura perché dovremo ripeterla per entrare in modalità programmazione)
3. Premete SET di seguito finché sul display non compare P4, quindi premete contemporaneamente entrambi i pulsanti del termostato, inizierà a lampeggiare il secondo valore del termostato. **Attenzione:** quando siete in modalità programmazione nel termostato, se non fate niente per 5 secondi la modalità torna normale e dovete ripetere i passaggi
...
![Riscaldatore montato sulla stampante](/images/PXL_20211129_195206812-1024x834.jpg)

## Piccoli accorgimenti

1. Vi consiglio comunque prima di inserirlo nella stampante, di lasciarlo acceso diverse ore in un posto "sicuro" in modo da verificare che tutto funzioni a dovere
